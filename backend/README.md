...
## Project Structure
    ...
    ├── ideapros_llc_aurora_33808  # Django project configurations
...
1. Clone this repo and `cd ideapros_llc_aurora_33808`
...
2. Clone this repo and `cd ideapros_llc_aurora_33808`
